...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Lateral Group") |
| group        | string   | Parent company group (e.g. "Lateral Group") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)