...
Acest proiect folosește [GitHub Issues](https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/issues) pentru a urmări munca.
...
Vezi [toate issue-urile](https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/issues).
