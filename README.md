[![Oportunitati SI Cariere](https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/peviitor-scrapers/lateral-srl-nodejs-scraper/actions/workflows/automation-testing.yml)
[![Version](https://img.shields.io/github/package-json/v/peviitor-scrapers/lateral-srl-nodejs-scraper?label=version&color=blue)](CHANGELOG.md)
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://peviitor-scrapers.github.io/lateral-srl-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/peviitor-scrapers/lateral-srl-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://peviitor-scrapers.github.io/lateral-srl-nodejs-scraper/)

# job_seeker_ro_spider — Lateral Group Careers Romania Scraper

**job_seeker_ro_spider** — un scraper pentru job-urile Lateral Group din România. Extrage anunțurile din [Lateral Group Careers](https://careers.lateralgroup.com) (RSS feed) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul Peviitor.
...
- Extrage job-uri din RSS feed-ul Lateral Group Careers, filtrate pentru România
